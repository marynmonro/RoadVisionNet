...
python segment/val2.py --weights yolov5s-seg.pt --data coco.yaml --img 640  # validate
```
...
python classify/val2.py --weights yolov5m-cls.pt --data ../datasets/imagenet --img 224  # validate
```
